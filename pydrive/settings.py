...
SETTINGS_STRUCT = {
    ...
    "save_credentials": {
        ...
        "required": True,
        "default": False,
        "dependency": [{"value": True, "attribute": ["save_credentials_backend"]}],
    },
    ...
    "save_credentials_backend": {
        "type": str,
        "required": False,
        "dependency": [{"value": "file", "attribute": ["save_credentials_file"]}],
    },
    "client_config": {
        "type": dict,
        "required": False,
    ...
    "service_config": {
        ...
        "required": False,
        "struct": {
            "client_user_email": {"type": str, "required": True, "default": None},
        ...
        for element in data[key]:
            if type(element) is not struct[key]["struct"]:
                raise InvalidConfigError(
                    "Setting %s should be list of %s" % (key, struct[key]["struct"])
                )
